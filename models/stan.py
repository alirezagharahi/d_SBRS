...
#        content_df = content[1]
    ...
    def fit(self, train, content, test=None, d=None):
        '''
    ...
    def predict_next( self, session_id, input_item_id, item_set, predict_for_item_ids, input_user_id=None, timestamp=0, skip=False, type='view'):
        '''
...
#         print( 'cknn.predict_next: ', process.memory_info().rss, ' memory used')
    ...
    def calc_similarity(self, session_items, sessions, timestamp ):
        ...
        for session in sessions:
            ...
            neighbors.append((session, similarity,self.diversity_of_session(session)))
